...
\title{Klastrowanie wyborców w oparciu o ich preferencje}
\tytulang{Clustering voters by their preferences}
...
\opiekun{dr. hab. Piotra Skowrona\\
...
\begin{abstract}
W pracy zastosowano algorytmy klastrowania do danych wyborczyn w głosowaniu
przez aprobaty na budżet partycypacyjy, uwzględniając zarówno dane z faktycznych
wyborów i modele syntetyczne. Przeanalizowano różne definicje odległości głosów
pod kątem efektywności znajdowania grup wyborców głosujących podobnie.
\end{abstract}
